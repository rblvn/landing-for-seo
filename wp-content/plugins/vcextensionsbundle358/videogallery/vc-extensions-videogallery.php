...
if (!class_exists('VC_Extensions_VideoGallery')){
    class VC_Extensions_VideoGallery{
      ...
      function cq_vc_videogallery_func($atts, $content=null) {
        ...
        // $output .= '<div class="cq-videogallery-thumbarrows">';
        // $output .= '<div class="videogallery-thumb-prev">';
        // $output .= '<i class="cq-videogallery-icon entypo-icon entypo-icon-up-open-big"></i>';
        // $output .= '</div>';
        // $output .= '<div class="videogallery-thumb-next">';
        // $output .= '<i class="cq-videogallery-icon entypo-icon entypo-icon-down-open-big"></i>';
        // $output .= '</div>';
        // $output .= '</div>';
