...
<?php  ?>
              <div class="template_wc_telsender">
                <p><?php _e("woocommerce template", "telsender"); ?> <smal><a href="https://pechenki.top/telsender.html#listcode" target="_blank">All tags</a></smal>
                </p>

                <textarea id="tscfwc_setting_wooc_template_editor" name="tscfwc_setting_wooc_template" rows="8" cols="80"><?= stripcslashes(html_entity_decode($this->tscfwc->Option('tscfwc_setting_wooc_template'))); ?></textarea>
