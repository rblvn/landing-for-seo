...
return array(
	...
	'params' => array_merge( array(
		...
		'title_bgcolor' => array(
			...
			'type' => 'color',
			'std' => us_get_color( 'color_content_bg_alt', TRUE ),
			'cols' => 2,
			'group' => us_translate( 'Style' ),
		),
		'title_textcolor' => array(
			...
			'type' => 'color',
			'with_gradient' => FALSE,
			'std' => us_get_color( 'color_content_heading' ),
			'cols' => 2,
			'group' => us_translate( 'Style' ),
		),
		'content_bgcolor' => array(
			...
			'type' => 'color',
			'std' => us_get_color( 'color_content_bg', TRUE ),
			'cols' => 2,
			'group' => us_translate( 'Style' ),
		),
		'content_textcolor' => array(
			...
			'type' => 'color',
			'with_gradient' => FALSE,
			'std' => us_get_color( 'color_content_text' ),
			'cols' => 2,
			'group' => us_translate( 'Style' ),
		),
