...
return array(
	...
	'params' => array_merge( array(
		...
		'field_bg_color' => array(
			...
			'header_std' => isset( $usof_options['color_header_search_bg'] ) ? $usof_options['color_header_search_bg'] : '',
			'cols' => 2,
		),
		'field_text_color' => array(
			...
			'std' => '',
			// fallback for old versions, when Search colors were in Theme Options
			'header_std' => isset( $usof_options['color_header_search_text'] ) ? $usof_options['color_header_search_text'] : '',
			'cols' => 2,
		),
		'icon' => array(
			'title' => __( 'Icon', 'us' ),
