...
return array(
	...
	'params' => array_merge( array(
		...
		'color_active_bg' => array(
			...
			// fallback for old versions, when Menu colors were in Theme Options
			'std' => us_arr_path( $usof_options, 'color_menu_active_bg', 'transparent' ),
		...
		'color_active_text' => array(
			...
			// fallback for old versions, when Menu colors were in Theme Options
			'std' => us_arr_path( $usof_options, 'color_menu_active_text', $usof_options['color_header_middle_text_hover'] ),
			'group' => us_translate( 'Colors' ),
		),
		'color_transparent_active_bg' => array(
			...
			// fallback for old versions, when Menu colors were in Theme Options
			'std' => us_arr_path( $usof_options, 'color_menu_transparent_active_bg', 'transparent' ),
			'group' => us_translate( 'Colors' ),
		),
		'color_transparent_active_text' => array(
			...
			// fallback for old versions, when Menu colors were in Theme Options
			'std' => us_arr_path( $usof_options, 'color_menu_transparent_active_text', $usof_options['color_header_transparent_text_hover'] ),
			'group' => us_translate( 'Colors' ),
		),
		'color_hover_bg' => array(
			...
			// fallback for old versions, when Menu colors were in Theme Options
			'std' => us_arr_path( $usof_options, 'color_menu_hover_bg', 'transparent' ),
			'group' => us_translate( 'Colors' ),
		),
		'color_hover_text' => array(
			...
			// fallback for old versions, when Menu colors were in Theme Options
			'std' => us_arr_path( $usof_options, 'color_menu_hover_text', $usof_options['color_header_middle_text_hover'] ),
			'group' => us_translate( 'Colors' ),
		),
		'color_drop_bg' => array(
			'type' => 'color',
			...
			// fallback for old versions, when Menu colors were in Theme Options
			'std' => us_arr_path( $usof_options, 'color_drop_bg', $usof_options['color_content_bg'] ),
			'group' => us_translate( 'Colors' ),
		),
		'color_drop_text' => array(
			...
			// fallback for old versions, when Menu colors were in Theme Options
			'std' => us_arr_path( $usof_options, 'color_drop_text', $usof_options['color_content_text'] ),
			'group' => us_translate( 'Colors' ),
		),
		'color_drop_hover_bg' => array(
			...
			// fallback for old versions, when Menu colors were in Theme Options
			'std' => us_arr_path( $usof_options, 'color_drop_hover_bg', $usof_options['color_content_primary'] ),
			'group' => us_translate( 'Colors' ),
		),
		'color_drop_hover_text' => array(
			...
			// fallback for old versions, when Menu colors were in Theme Options
			'std' => us_arr_path( $usof_options, 'color_drop_hover_text', '#fff' ),
			'group' => us_translate( 'Colors' ),
		),
		'color_drop_active_bg' => array(
			...
			// fallback for old versions, when Menu colors were in Theme Options
			'std' => us_arr_path( $usof_options, 'color_drop_active_bg', 'transparent' ),
			'group' => us_translate( 'Colors' ),
		),
		'color_drop_active_text' => array(
			...
			// fallback for old versions, when Menu colors were in Theme Options
			'std' => us_arr_path( $usof_options, 'color_drop_active_text', $usof_options['color_content_primary'] ),
			'group' => us_translate( 'Colors' ),
		),
