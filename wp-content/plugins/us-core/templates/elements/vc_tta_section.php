...
$output .= '<div class="w-tabs-section-content' . $content_classes . '" id="content-' . $tab_id . '" aria-expanded="' . ( $active ? 'true' : 'false' ) . '">';
$output .= '<div class="w-tabs-section-content-h i-cf">' . $content_html . '</div>';
$output .= '</div></div>';
